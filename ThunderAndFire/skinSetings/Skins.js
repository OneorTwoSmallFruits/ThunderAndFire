...
let origintaici = {
    ...
    TAF_lvbu_three:{//神吕布
        ...
        TAF_kuangbao_shadow:{
            order: 2,
            content: "骨肉为宴，吾为战狂!<br>神魔现世，当负命而还!",
        },
        TAF_wushuang:{
            order: 3,
