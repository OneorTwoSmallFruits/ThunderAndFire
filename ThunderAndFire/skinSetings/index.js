...
import { taici } from'./taici.js';
import { gonglve } from'./gonglve.js';
import { skininfo } from'./skininfo.js';
 ...
 * 皮肤设置
 */
export const skinsetings = {
    isExt: true, // 是否是扩展，一般填 true
    filterCharacter: function (name) {
        return Object.keys(characters).includes(name);
    },
    ...
    originSkinInfo: function (name) {
        const info = {
            TAF_shen_zhaoyun: '画师：DH',
            sun_simayi: '画师：木美人',
            sun_zhangchunhua: '画师：depp',
            TAF_sf_caocao: '画师：鬼画府',
            TAF_sf_liubei: '画师：鬼画府',
            TAF_sf_sunquan: '画师：鬼画府',
            moon_guojia: '画师：鬼画府',
            moon_zhugeliang: '画师：未知',
            moon_zhouyu: '画师：鬼画府',
            moon_simahui: '画师：凡果_Make',
