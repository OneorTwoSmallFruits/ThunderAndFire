...
export const 惊世银竹 = {
    ...
    thunder_zhonghui:{//钟会
        thunderyulei:{
            order: 1,
            content: "风水轮流转，轮到我钟谋问鼎重几何了。<br>空将宝地赠他人，某怎会心甘情愿？<br>入宝山而空手回，其与匹夫何异？<br>天降大任于斯，不受必遭其殃！<br>汉鹿已失，魏牛犹在，吾欲执其耳。<br>我欲行夏禹旧事，为天下任！",
        },
        thunderfulong:{
            order: 2,
            content: "我若束手无策，诸位又有何施为？<br>今长缨在手，欲问鼎九州！<br>我有佐国之术，可缚苍龙！<br>窃钩者诛，窃国者侯，会欲窃九州为狩。<br>经略四州之地，可钓金鲤于渭水。<br>今提三尺剑，开万里疆，九鼎不足为重！",
        },
        thunderyujun:{
            order: 3,
            content: "与君相逢恨晚，数语难道天下谊。<br>会不轻易信人，唯不疑伯约。<br>于天下觉春秋尚早，于伯约恨相见太迟。<br>与君并肩高处，可观众山之小。<br>你我虽异父异母，亦可约为兄弟。<br>我以国士待伯约，伯约定不负我。",
        },
        die:{
            content:"兵来似欲作恶，当云何？伯约误我，谋事在人成事在天。",
        }
    },
};
export const 期期离火 = {
    ...
    fire_jiangwei:{//姜维
        firelinyan:{
            order: 1,
            content: "红日未落，炎汉犹存，此正志士用武之时。<br>维既抱逐日之远志，不在念当归之遐思。<br>怀麒麟之志，负柱国之托，奔天涯海角！<br>炎阳在悬，岂因乌云障日，而弃金光于野？<br>三尺台上释千古，一曲谱半生，影随光而行。<br>影绎当年蹉跎，戏如人生，几声锣鼓惊春风。",
        },
        firebazhen:{
            order: 2,
            content: "无",
        ...
        fireyujun:{
            order: 3,
            content: "你我虽各为其主，然不乏相惜之谊。<br>浮生路长，若得遇知己，何其幸哉。<br>九州齐喑，我辈燃己长明，君欲同否？<br>英才救世，从者皆众，请君拨乱反正。<br>国破家亡，君乃最后一线之生机。<br>君才胜司马氏十倍，何故居于人下？",
        },
        die:{
            content:"姜维姜维，又将何为？",
        }
...
export const 惊鸿玉蝶 = {
    ice_diaochan:{//貂蝉
        icelijian:{
            order: 1,
            content: "你们的争斗，不过是我指尖的傀儡戏。<br>我动动指尖，便能让山河变色，群雄皆醉。",
        },
        icebiyue:{
            order: 2,
            content: "血流成河，方不负我倾世的容颜。<br>看你们为我疯魔厮杀，才是这世间最美的风景。",
        },
        die:{
            content:"待我归来，定让这天下再为我癫狂。",
        }
    },
    ice_lvlingqi:{//吕玲绮
        icewushuang:{
...
export const 其他武将 = {
    TAF_qt_SEsunluban:{//SE孙鲁班
        waterjiaoman:{
            order: 1,
            content: "本宫比之猛虎，谁更使人惧乎？<br>猛虎食人心肝，本宫灭人神魂。",
        },
        die:{
            content: "生于朱楼高阙，谈何亲情？",
        }
    ...
    TAF_qt_SEjiaxu:{//SE贾诩
        thunderweimu:{
            order: 1,
            content: "恩仇付浊酒，荡平劫波，且做英雄吼。<br>人无恒敌，亦无恒友，唯有恒利。<br>不周之柱已折，这世间，当起一阵风、落一场雨!<br>善谋者，不与善战者争功。",
        },
        thunderwenhe:{
            order: 2,
            content: "谋先于行则昌，行先于谋则亡。<br>天行五色，雪覆林间睡狐，独我执白。<br>我有三窟之筹谋，不蹈背水之维谷。<br>已积千里跬步，欲履万里河山。",
        },
        thundermoushen:{
            order: 3,
            content: "孤立川上，观逝者如东去之流水。<br>九州如画，怎可空老人间？<br>曾寄青鸟凌云志，归来城头看王旗。<br>烽火照长安，淯水洗枯骨，今日对弈何人？",
        },
        die:{
            content: "未见青山草木，枯骨徒付浊流。",
        }
    },
    TAF_qt_SElinxi:{//喵林夕
        icexihuo:{
...
if (!skinschange) {
    ...
    期期离火.fire_jiangwei = {
        ...
        fireranji:{
            order: 4,
            content: "国恩浩荡，此身食禄而长，亦当报于家国。<br>天下齐喑，我辈秉身为烛，当照四海九州。<br>孤鸿鸣于野，其以身为凤，引春风入汉关。<br>古来圣贤卫道而死，道之存焉何惜深入九渊？<br>秉笔客书江湖事，执灯叟照当年人。<br>皮影话峥嵘，千古兴亡事，一杯浊酒中。",
        },
        die:{
            content:"姜维姜维，又将何为？",
        }
    ...
    其他武将.TAF_qt_SEsunluban = {
        ...
        waterzenhui:{
            order: 2,
            content: "我的好妹妹，来世莫要生于帝王家。<br>至尊有诏，不从长公主者，斩！",
        },
        waterxieming:{
            order: 3,
            content: "本公主在此，岂容你们放肆。<br>我可不是，任你们拿捏的。",
        },
        waterfuxiong:{
            order: 4,
            content: "公主之位，众口之谮。<br>一船之人，你怎可独自上岸。",
        },
        waterzhanqing:{
            order: 5,
            content: "尔等欺君罔上，还敢抵赖。<br>哼，真以为我能饶过你。",
        },
        die:{
            content: "生于朱楼高阙，谈何亲情？",
        }
