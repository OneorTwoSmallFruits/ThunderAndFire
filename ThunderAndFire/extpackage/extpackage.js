...
export const extpackage = {
    ...
    intro: 
        ...
        setstyle('1.4　感谢名单：') + setstyle('❀非时之梦，常世灶食℘-Q群及群主和各位管理员；眯咪狗《奇妙工具·自娱自乐》；真里亞《武将背景特效》；“绘声03”小伙伴提供的武将皮肤和语音资源；银竹离火编写初期，এ钟士季ꦿ℘゜的鼎力支持', 'red') + '<br>' +
        setstyle('1.5　命名由来：') + 
        ...
        setstyle('1.6　扩展版本：V1.31.4　更新日期：2025年07月04日 - 增加播放台词时，添加对应logSkill事件。') + '<br>' +
        '',
    diskURL: '',
    forumURL: '',
    version: '1.31.4',
