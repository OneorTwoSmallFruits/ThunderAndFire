...
const TAF_wuxingSkills = {
    ...
    TAFwuxing: {
        ...
        async init(player, skill) {
            ...
            const setlist = ['TAF_wx_xuanyuan','TAF_wx_rongcheng','TAF_wx_shentu','TAF_wx_wenren','TAF_wx_gongyi'];
        ...
        async content(event, trigger, player) {
            ...
            // 相生相克制
            const 相生相克 = {
                'TAF_wx_xuanyuan': { self: '金', win: 'TAF_wx_rongcheng', lose: 'TAF_wx_wenren' },   // 金克木，被火克
                'TAF_wx_rongcheng': { self: '木', win: 'TAF_wx_gongyi', lose: 'TAF_wx_xuanyuan' },   // 木克土，被金克
                'TAF_wx_shentu': { self: '水', win: 'TAF_wx_wenren', lose: 'TAF_wx_gongyi' },       // 水克火，被土克
                'TAF_wx_wenren': { self: '火', win: 'TAF_wx_xuanyuan', lose: 'TAF_wx_shentu' },     // 火克金，被水克
                'TAF_wx_gongyi': { self: '土', win: 'TAF_wx_shentu', lose: 'TAF_wx_rongcheng' },    // 土克水，被木克
            };
