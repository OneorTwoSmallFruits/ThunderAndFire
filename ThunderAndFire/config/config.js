...
export const config = {
    ...
    TAFset_TAF_lvbu_three: {//设置3.9：神吕布
        name: "3.9　神吕布完全体加入将池",
		init: false, // 默认关闭
        intro: "本扩展BOSS神吕布将以完全体形态加入本扩展《其他武将》将池：体力值上限为9；移除觉醒技能【修罗】，【赤焰】手牌上限改为体力值上限且至多为7；玩家可在身份场等模式体验；默认关闭！",
    },
    TAFset_TAF_shenguigaoda: {//设置3.10：神鬼高达
        name: "3.10　神鬼高达加入将池",
		init: false, // 默认关闭
        intro: "本扩展BOSS神鬼高达加入本扩展《神话再临》将池；玩家可在身份场等模式体验；默认关闭！",
    },
    TAFset_TAF_ZQY_compete: {//设置3.11：参赛版
        name: "3.11　张琪瑛参赛投稿版",
		init: true, // 默认开启
        ...
        if(item && typeof item === "object"){
            ...
            for (let key of keys) {
                ...
                const list1 = [
                    ...
                    '不凡','不由己','凡人','凡人不凡','归潮','归期','落英','屁','少年不凡','天地行','望乡曲','勿听','修仙缘',
